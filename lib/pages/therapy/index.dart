...
class _TherapyPageState extends State<TherapyPage> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          GestureDetector(
            onTap: () {
              Utils.exportTherapy(therapies);
            },
            child: Image.asset(iconExport, width: 20, height: 20),
          ),
          IconButton(
            icon: const Icon(Icons.add),
            onPressed: () => Navigator.pushNamed(context, addVisitView),
          ),
          IconButton(
            onPressed: () {
              showDialog(
                                ...
                                onTap: () async {
                                  try {
                                    ...
                                    SnackBarUtil.showSnack(
                                      context,
                                      'Gagal menghapus data berobat. ${e.toString()}',
                                    ) ;
                                  }
                                },
                              ),
            ...
            if (searchController.text.isEmpty) {
              ...
              List<QueryDocumentSnapshot> sortedData =
                  (snapshot.data?.docs ?? []).toList()..sort((a, b) {
                    TransactionTherapy dtA = a.data() as TransactionTherapy;
                    TransactionTherapy dtB = b.data() as TransactionTherapy;
              ...
              therapies = sortedData
                  .map((e) => e.data() as TransactionTherapy)
                  .toList();
            }
            ...
            return Padding(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  TransactionTherapy item = therapies[index];
  ...
  List<TransactionTherapy> searchVisit(
    List<TransactionTherapy> vists,
    String query,
  ) {
